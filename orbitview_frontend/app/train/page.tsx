    ...
    <main className="min-h-screen bg-[#000d20] py-12">
      <div className="container max-w-6xl mx-auto px-4">
        <div className="mb-8">
          ...
          <p className="text-[#97c9db] text-lg">
        ...
        <div className="mb-12 text-left">
          <Card className="p-6 bg-[#000d20] border-[#97c9db] inline-block">
            <p className="text-[#97c9db] mb-4">
              Want to import your existing content from other platforms?
            </p>
            <Button
              variant="outline"
              className="border-[#3d778c] text-[#97c9db] hover:bg-[#3d778c] hover:text-[#fbffff]"
              asChild
            >
